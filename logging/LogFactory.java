...
public class LogFactory {
    ...
    private static void tryImplementation(String testClassName, String implClassName) {
        ...
        try {
            ...
            if (!LampLog.class.isAssignableFrom(declareClass)) {
                logConstructor = null;
            }
    ...
    public static LampLog getLog(Class clazz) {
        return getLog(clazz.getName());
    }

    public static LampLog getLog(String loggerName) {
        try {
            return (LampLog) logConstructor.newInstance(loggerName);
        } catch (Throwable t) {
